...
![docker環境例](https://user-images.githubusercontent.com/80142183/161220581-032c7aac-2195-4dc4-bfab-04fc3efa21f3.png)
※一例
* Laravelで開発しようとした時に、ただVScodeを開いて、Larabelをインストールすれば開発できるわけではなく、色々と環境を作らなければなりません、その時Dockerを使用して開発ができる環境を簡単に構築ができます。
* AWSでのデプロイを考えたら、Dockerで環境構築しておくと楽だと思います。
...
## 所感
* Laravelを初めて使用したので、基本的なところを触りましたが、フルスタックに開発するイメージが付くように感じました。
* フロントにはReact.jsを使用することも可能です。
* Dockerでの環境構築とAWSでの簡易なデプロイを学びました。
